...
Comprehensive guide to choosing names that reveal intent, avoid disinformation, and make code read like well-written prose. Based on Robert C. Martin's _Clean Code_, Chapter 2.
...
| `list`   | `flaggedAccounts`         | Describes _which_ list and _why_ it exists       |
