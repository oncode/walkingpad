...
This prototype answers: "Does collaborative filtering work with our data?" The code is not production-quality and should never ship. But the _learning_ it produces guides the real implementation.
