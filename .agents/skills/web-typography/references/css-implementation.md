...
@font-face {
  font-family: "Custom Font";
  src:
    url("/fonts/custom-italic.woff2") format("woff2"),
...
src:
  ...
  /* Best compression, 97%+ support */ url("font.woff") format("woff"); /* Fallback for older browsers */
```
...
body {
  font-family:
    -apple-system,
    /* Safari on macOS and iOS */ BlinkMacSystemFont,
    /* Chrome on macOS */ "Segoe UI",
    /* Windows */ Roboto,
    /* Android, Chrome OS */ "Helvetica Neue",
    /* Older macOS */ Arial,
...
pre {
  font-family:
    ui-monospace,
    /* San Francisco Mono on macOS */ "Cascadia Code",
    /* Windows Terminal */ "Source Code Pro",
    /* Popular fallback */ Menlo,
    /* macOS */ Consolas,
    /* Windows */ monospace;
}
```
